...
const NewContact = () => {
  ...
  const onSubmit = async contactInfo => {
    const contactVerified = await getDataByQueryParams('chats', { contactPhoneNumber: contactInfo.contactPhoneNumber })
          ...
          <div className="form__input-wrapper">
            <div className="input-container">
              <input 
                ...
                required 
                />
              <label className="input-label" htmlFor="">Enter a name</label>
            ...
            <div className="input-container">
              ...
              required 
              />
              <label className="input-label" htmlFor="">Enter a phone number</label>
              <div className="form__input--error error"></div>
            </div>
          </div>
          <input className="form__submit" type="submit" value="Add new contact" />
        </form>
      </div>
    </div>
  )
