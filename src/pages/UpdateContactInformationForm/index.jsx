  ...
  return (
    <section className="edit-contact-container">
      <div className="edit-contact-container__header">
        <img className="edit-contact-container__header--back-icon" src={backIcon} alt="back"/>
      ...
      <form className="edit-contact-container__form form">
        <div className="first-container">
          ...
          <div className="group-inputs">
            <div className="input-container">
              <input id="edit-input-name" className="form__input" type="text"/>
              <label className="input-label" htmlFor="edit-input-name">First name</label>
            </div>
            <div className="input-container">
              <input id="edit-input-lastname" className="form__input" type="text"/>
        ...
        <div className="i-icons"><FaPhoneAlt/></div>
          <div className="input-container">
            <input id="edit-input-phone" className="form__input"  type="text"/>
